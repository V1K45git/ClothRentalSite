...
try{
	...
	PreparedStatement ps1=con.prepareStatement("update cart set address=?,city=?,state=?,country=?,mobileNumber=?,paymentMethod=?,transactionId=?,status=? where email=? and address is NULL");
