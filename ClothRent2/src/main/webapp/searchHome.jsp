...
<table>
        <thead>
          <tr>
            ...
            <th scope="col"><i class="fa fa-inr"></i>Rent Price</th>
...
catch(Exception e)
{
	System.out.println(e);
      	...
      	<% if(z==0) {%>
	<h1 style="color:white; text-align: center;">There is No Such Product Exist</h1>
	<%} %>
      <br>
      <br>
      <br>
      <div class="footer">
          <p>All right reserved by Vikas Singh Panwar</p>
      </div>
